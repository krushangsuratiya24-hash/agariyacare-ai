...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  AGARIYA_WORKER: [
    ...
    { key: 'mySalt',        label: 'nav.mySalt',        path: '/my-salt',        icon: <Icon.Salt /> },
    { key: 'saltMarket',    label: 'nav.saltMarket',    path: '/salt-market',    icon: <Icon.Market /> },
    ...
    { key: 'mySales',       label: 'nav.mySales',       path: '/my-sales',       icon: <Icon.Analytics /> },
    { key: 'healthcare',    label: 'nav.healthcare',    path: '/healthcare',     icon: <Icon.Health /> },
    { key: 'safety',        label: 'nav.safety',        path: '/safety',         icon: <Icon.Safety /> },
    ...
    { key: 'aiAssistant',   label: 'nav.aiAssistant',   path: '/ai-assistant',   icon: <Icon.AI /> },
  ],
  BUYER: [
    { key: 'dashboard',      label: 'nav.dashboard',      path: '/dashboard',       icon: <Icon.Dashboard /> },
    { key: 'saltMarket',     label: 'nav.saltMarket',     path: '/salt-market',     icon: <Icon.Market /> },
    { key: 'buyerRequests',  label: 'nav.buyerRequests',  path: '/buyer-requests',  icon: <Icon.Offers /> },
    { key: 'myOffers',       label: 'nav.myOffers',       path: '/my-offers',       icon: <Icon.Offers /> },
    { key: 'transactions',   label: 'nav.transactions',   path: '/transactions',    icon: <Icon.Purchases /> },
    { key: 'savedListings',  label: 'nav.savedListings',  path: '/saved-listings',  icon: <Icon.Bookmark /> },
    { key: 'aiAssistant',    label: 'nav.aiAssistant',    path: '/ai-assistant',    icon: <Icon.AI /> },
  ],
  COORDINATOR: [
    { key: 'dashboard',   label: 'nav.dashboard',   path: '/dashboard',    icon: <Icon.Dashboard /> },
    { key: 'safety',      label: 'nav.safety',      path: '/safety',       icon: <Icon.Safety /> },
    { key: 'healthcare',  label: 'nav.healthcare',  path: '/healthcare',   icon: <Icon.Health /> },
    { key: 'saltMarket',  label: 'nav.marketplace', path: '/salt-market',  icon: <Icon.Market /> },
    { key: 'aiAssistant', label: 'nav.aiAssistant', path: '/ai-assistant', icon: <Icon.AI /> },
    { key: 'community',   label: 'nav.community',   path: '/community',    phase: 3, icon: <Icon.Community /> },
