...
const NAV_ITEMS: Record<UserRole, NavItem[]> = {
  AGARIYA_WORKER: [
    ...
    { key: 'myOffers',    label: 'nav.myOffers',    path: '/my-offers',     phase: 2, icon: <Icon.Offers /> },
    { key: 'mySales',     label: 'nav.mySales',     path: '/my-sales',      phase: 2, icon: <Icon.Sales /> },
  ...
  BUYER: [
    ...
    { key: 'myOffers',       label: 'nav.myOffers',       path: '/my-offers',         phase: 2, icon: <Icon.Offers /> },
    { key: 'purchases',      label: 'nav.purchases',      path: '/purchases',         phase: 2, icon: <Icon.Purchases /> },
...
export const BottomNav: React.FC = () => {
  ...
  const mobileItems: Record<UserRole, NavItem[]> = {
    ...
    BUYER: [
      ...
      { key: 'saltMarket', label: 'nav.saltMarket', path: '/salt-market', phase: 2, icon: <Icon.Market /> },
      { key: 'myOffers',   label: 'nav.myOffers',   path: '/my-offers',   phase: 2, icon: <Icon.Offers /> },
      { key: 'ai',         label: 'nav.aiAssistant',path: '/ai',          phase: 4, icon: <Icon.AI /> },
    ],
    COORDINATOR: [
      { key: 'dashboard',  label: 'nav.dashboard',  path: '/dashboard', icon: <Icon.Dashboard /> },
      { key: 'support',    label: 'nav.support',    path: '/support',   phase: 3, icon: <Icon.Support /> },
